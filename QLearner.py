    ...
    def query(self, s_prime, r):  		  	   		  	  			  		 			     			  	 
        ...
        if self.dyna != 0:
            ...
            for i in range(0, self.num_states):            
                self.T_table[self.s, self.a, s_prime] = self.Tcount_table[self.s, self.a, i] / sum(self.Tcount_table[self.s, self.a])
            ...
            for i in range(0, self.dyna):
                ...
                self.Q_table[s_rand, a_rand] = prevQ_Val + improved_futureEstimate
